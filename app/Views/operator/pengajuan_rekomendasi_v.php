                            ...
                            <div class="ms-auto">
                                <ul class="list-unstyled mb-0">
                                    <li class="list-inline-item text-info">
                                        ...
                                        <a href="/operator/form_pengajuan_rekomendasi" class="btn btn-outline-primary btn-sm">Ajukan Permohonan Surat Rekomendasi</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#rekom_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '/operator/pengajuan_rekom/getPengajuanRekom',
                method: 'POST'
            },
            order: [],
            columns: [{
