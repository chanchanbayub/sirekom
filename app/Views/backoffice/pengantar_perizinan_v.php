                ...
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="pengantar_table">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">Surat Pengantar Perizinan</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_form">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                        <label for="surat_pengantar" class="col-form-label">Surat Pengantar Perizinan :</label>
                        <input type="text" class="form-control" id="surat_pengantar" name="surat_pengantar">
            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <label for="surat_pengantar_edit" class="col-form-label"><?= $title ?> :</label>
                        <input type="text" class="form-control" id="surat_pengantar_edit" name="surat_pengantar">
...
<script>
    $(document).ready(function() {
        $('#pengantar_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '/backoffice/surat_pengantar/getPengantarPerizinan',
                method: 'POST'
            },
            order: [],
            columns: [{
    ...
    $("#add_form").submit(function(e) {
        ...
        let surat_pengantar = $("#surat_pengantar").val();

        $.ajax({
            url: '/backoffice/surat_pengantar/insert',
            method: 'post',
            dataType: 'JSON',
            data: {
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.surat_pengantar) {
                        $("#surat_pengantar").addClass('is-invalid');
                        $("#error-pengantar").html(response.error.surat_pengantar);
                    } else {
                        $("#surat_pengantar").removeClass('is-invalid');
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            url: '/backoffice/surat_pengantar/edit',
            method: 'get',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                $("#surat_pengantar_edit").val(response.surat_pengantar);
    ...
    $("#edit_form").submit(function(e) {
        e.preventDefault();
        let id = $('#id_edit').val();
        let surat_pengantar = $('#surat_pengantar_edit').val();

        $.ajax({
            url: '/backoffice/surat_pengantar/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.surat_pengantar) {
                        $("#surat_pengantar_edit").addClass('is-invalid');
                        $(".error-pengantar-edit").html(response.error.surat_pengantar);
                    } else {
                        $("#surat_pengantar_edit").removeClass('is-invalid');
    ...
    $("#delete_form").submit(function(e) {
        ...
        $.ajax({
            url: '/backoffice/surat_pengantar/delete',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
