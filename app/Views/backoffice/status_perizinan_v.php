        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_form">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                        <label for="status_perizinan" class="col-form-label">Status Perizinan :</label>
                        <input type="text" class="form-control" id="status_perizinan" name="status_perizinan">
            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <label for="status_perizinan_edit" class="col-form-label"><?= $title ?> :</label>
                        <input type="text" class="form-control" id="status_perizinan_edit" name="status_perizinan">
...
<script>
    $(document).ready(function() {
        $('#role_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '/backoffice/status_perizinan/getStatusPerizinan',
                method: 'POST'
            },
            order: [],
            columns: [{
    ...
    $("#add_form").submit(function(e) {
        ...
        let status_perizinan = $("#status_perizinan").val();

        $.ajax({
            url: '/backoffice/status_perizinan/insert',
            method: 'post',
            dataType: 'JSON',
            data: {
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.status_perizinan) {
                        $("#status_perizinan").addClass('is-invalid');
                        $("#error-role").html(response.error.status_perizinan);
                    } else {
                        $("#status_perizinan").removeClass('is-invalid');
                        $("#error-role").html('');
                    }
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            url: '/backoffice/status_perizinan/edit',
            method: 'get',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                $("#status_perizinan_edit").val(response.status_perizinan);
    ...
    $("#edit_form").submit(function(e) {
        e.preventDefault();
        let id = $('#id_edit').val();
        let status_perizinan = $('#status_perizinan_edit').val();

        $.ajax({
            url: '/backoffice/status_perizinan/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.status_perizinan) {
                        $("#status_perizinan_edit").addClass('is-invalid');
                        $(".error-status-edit").html(response.error.status_perizinan);
                    } else {
                        $("#status_perizinan_edit").removeClass('is-invalid');
    ...
    $("#delete_form").submit(function(e) {
        ...
        $.ajax({
            url: '/backoffice/status_perizinan/delete',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
