            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <label for="jenis_kendaraan_edit" class="col-form-label"><?= $title ?> :</label>
...
<script>
    $(document).ready(function() {
        $('#role_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '/backoffice/jenis_kendaraan/getJenisKendaraan',
                method: 'POST'
            },
            order: [],
            columns: [{
    ...
    $("#add_form").submit(function(e) {
        ...
        $.ajax({
            url: '/backoffice/jenis_kendaraan/insert',
            method: 'post',
            dataType: 'JSON',
            data: {
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            url: '/backoffice/jenis_kendaraan/edit',
            method: 'get',
            dataType: 'JSON',
            data: {
                id: id,
    ...
    $("#edit_form").submit(function(e) {
        ...
        $.ajax({
            url: '/backoffice/jenis_kendaraan/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
    ...
    $("#delete_form").submit(function(e) {
        ...
        $.ajax({
            url: '/backoffice/jenis_kendaraan/delete',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
