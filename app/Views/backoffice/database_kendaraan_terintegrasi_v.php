                                    ...
                                    <?php if ($kendaraan_data != null) : ?>
                                        ...
                                        <?php foreach ($kendaraan_data as $data) : ?>
                                            <tr>
                                                ...
                                                <td><a href="/backoffice/database_kendaraan_terintegrasi/<?= urlencode($data["operator_kendaraan"]) ?>" class="btn btn-outline-primary btn-sm">Lihat Data Kendaraan</a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
                                        <tr>
...
<script>
    $(document).ready(function() {
        ...
        $("#add_form").submit(function(e) {
            ...
            $.ajax({
                url: '/backoffice/database_kendaraan_terintegrasi/insert',
                data: formData,
