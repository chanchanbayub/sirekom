...
class DatabaseKendaraanModel extends Model
{
    ...
    public function getDataKendaraanTable($operator)
    {
        ...
        $builder = $builder->select("data_base_kendaraan_2014_table.id, data_base_kendaraan_2014_table.nomor_kendaraan, data_base_kendaraan_2014_table.no_uji_kendaraan, data_base_kendaraan_2014_table.kode_trayek, data_base_kendaraan_2014_table.trayek, data_base_kendaraan_2014_table.operator, data_base_kendaraan_2014_table.alamat, data_base_kendaraan_2014_table.tahun, data_base_kendaraan_2014_table.merk, data_base_kendaraan_2014_table.awal_masa_berlaku, data_base_kendaraan_2014_table.habis_masa_berlaku, data_base_kendaraan_2014_table.tanggal_penerbitan, data_base_kendaraan_2014_table.jenis_kendaraan")
    ...
    {
        return $this->table($this->table)
            ->select("data_base_kendaraan_2014_table.operator,data_base_kendaraan_2014_table.nomor_kendaraan, data_base_kendaraan_2014_table.no_uji_kendaraan,data_base_kendaraan_2014_table.merk, data_base_kendaraan_2014_table.tahun, data_base_kendaraan_2014_table.jenis_kendaraan")
    ...
    {
        return $this->table($this->table)
            ->select("DISTINCT(data_base_kendaraan_2014_table.jenis_kendaraan) AS jenis_kendaraan")
            // ->select('id')
            // ->select("COUNT(database_kendaraan_table.operator) AS jumlah_kendaraan")
            ->orderBy('data_base_kendaraan_2014_table.id desc')
            ->get()->getResultObject();
    ...
    public function getDataKendaraan2014WhereJenis($jenis_kendaraan)
    {
        return $this->table($this->table)
            ->select("data_base_kendaraan_2014_table.jenis_kendaraan")
            ->where(["data_base_kendaraan_2014_table.jenis_kendaraan" => $jenis_kendaraan])
            // ->select('database_kendaraan_table.id')
            // ->select("COUNT(database_kendaraan_table.operator) AS jumlah_kendaraan")
            ->orderBy('data_base_kendaraan_2014_table.id desc')
            ->get()->getResultObject();
