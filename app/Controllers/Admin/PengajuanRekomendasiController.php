...
class PengajuanRekomendasiController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('backoffice/pengajuan_rekomendasi_v', $data);
    }

    public function getPengajuanRekom()
    {
        if ($this->request->isAjax()) {
            $rekom_pengajuan = $this->pengajuanRekomendasiModel->getPengajuanRekom();
            ...
            return DataTable::of($rekom_pengajuan)
                ...
                ->add('view', function ($row) {
                    return '<a href ="/backoffice/pengajuan_rekom/detail/' . $row->id . '/'  . $row->id . '/ " class="btn btn-sm btn-outline-primary" >
    ...
    public function form_pengajuan_rekomendasi()
    {
        ...
        return view('backoffice/form_pengajuan_rekom_v', $data);
    }
